...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.20]{smartwatch.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.35]{webpage.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{webconcept.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.30]{applicationsystem.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.14]{overall_system.png}
